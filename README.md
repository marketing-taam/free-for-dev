...
## Generative AI
  ...
  * [Taam Cloud](https://taam.cloud/ai-models-hub) - An AI integration platform with more than 200 AI models including GPT-4o, Llama, DeepSeek R1, Mixtral 7b, Claude Sonnet 3.7, and many more. Taam Cloud provides various free AI models that are subjected to rate limits. It also offers paid models with pay-as-you-go pricing model and an on premise AI infrastructure solutions.
